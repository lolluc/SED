function [lon,lat,delta,alpha] =...
    groundtracks(mu,om_earth,a,e,i,OM,om,th_0,t_fin,perturbation,th_gw0,plot_enable)
%
...
%                          -  'none'  -use unperturbed 2bp equations.
%                          -  'j2'    -use j2 perturbation model.
%    th_gw0 [1x1]  -angle between greenwich meridian and gamma direction at
...
om_earth=deg2rad(om_earth/3600); % planet rotational speed
...
switch perturbation
    ...
    case 'unperturbed'
        ...
        odegravity= @(t,r) [r(4); r(5) ; r(6); ...
            -mu*r(1)/((r(1)^2+r(2)^2+r(3)^2)^(3/2));...
            -mu*r(2)/((r(1)^2+r(2)^2+r(3)^2)^(3/2));...
            -mu*r(3)/((r(1)^2+r(2)^2+r(3)^2)^(3/2))] ;
    ...
    case 'j2'
        ...
        r_e=6378.137;
        % function to integrate
        j2x= @(t,r) 3/2*j_2*mu*r_e^2/((r(1)^2+r(2)^2+r(3)^2)^2)*...
            (r(1)/sqrt(r(1)^2+r(2)^2+r(3)^2)*(5*r(3)^2/(r(1)^2+r(2)^2+r(3)^2)-1));
        j2y= @(t,r) 3/2*j_2*mu*r_e^2/((r(1)^2+r(2)^2+r(3)^2)^2)*...
            (r(2)/sqrt(r(1)^2+r(2)^2+r(3)^2)*(5*r(3)^2/(r(1)^2+r(2)^2+r(3)^2)-1));
        j2z= @(t,r) 3/2*j_2*mu*r_e^2/((r(1)^2+r(2)^2+r(3)^2)^2)*...
            (r(3)/sqrt(r(1)^2+r(2)^2+r(3)^2)*(5*r(3)^2/(r(1)^2+r(2)^2+r(3)^2)-3));
        
        odegravity= @(t,r) [r(4); r(5) ; r(6); ...
            -mu*r(1)/((r(1)^2+r(2)^2+r(3)^2)^(3/2))+j2x(t,r);...
            -mu*r(2)/((r(1)^2+r(2)^2+r(3)^2)^(3/2))+j2y(t,r);...
            -mu*r(3)/((r(1)^2+r(2)^2+r(3)^2)^(3/2))+j2z(t,r)] ;
end
...
[t,u]= ode113(odegravity,[0;t_fin],[r0;v0],options);
r= u(1:end,1:3);
...
for ii=1:length(t)
    ...
    th_gw(ii)=th_gw0+om_earth*(t(ii)); % teta of greenwich (time)
